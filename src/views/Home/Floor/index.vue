          ...
          <div class="title clearfix">
              ...
              <div class="fr">
                  <ul class="nav-tabs clearfix">
                      <li :class="{active:currentIndex === index}" v-for="(item,index) in floorList.navList" :key="index" @click="currentIndex = index">
                          <a :href="item.url+index" data-toggle="tab">{{item.text}}</a>
                      </li>
                      <!-- <li>
